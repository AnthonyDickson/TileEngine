...
#ifndef LIBECONSIMPLUSPLUSEDITOR_ECONSIMPLUSPLUS_EDITOR_OPENFILEDIALOG_HPP
#define LIBECONSIMPLUSPLUSEDITOR_ECONSIMPLUSPLUS_EDITOR_OPENFILEDIALOG_HPP
...
namespace EconSimPlusPlus::Editor {
    ...
    public:
        ...
        void open(const pfd::open_file& fileDialog, const std::function<void(std::string)>& callback);
...
#endif // LIBECONSIMPLUSPLUSEDITOR_ECONSIMPLUSPLUS_EDITOR_OPENFILEDIALOG_HPP
